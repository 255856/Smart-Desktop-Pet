...
class TrayController(QObject):
    ...
    def __init__(self, app_name: str, icon_path: Optional[Path] = None, parent: Optional[QObject] = None):
        ...
        self.act_demo = QAction("Live2D Demo", menu)
        self.act_demo.setToolTip("在浏览器打开本地 Live2D 演示页 http://127.0.0.1:8765")
        self.act_trace = QAction("Agent Trace（开发）", menu)
        self.act_trace.setToolTip("打开可视化调试面板（Agent Trace，开发者） http://127.0.0.1:8766")
        ...
        menu.addAction(self.act_demo)
        menu.addAction(self.act_trace)
